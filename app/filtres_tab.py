                ...
                html.Div([
                    html.Div([
                        ...
                        html.Div([
                                    ...
                                    options=[{
                                        'label': html.Span([
                                            ...
                                            html.Span('PRODUIRE', style={
                                                'fontWeight': '700',
                                                'fontSize': '16px',
                                                'color': utils.dicolor_poles[utils.poles[0]],
                                                'letterSpacing': '0.5px'
                                            })
                                        ], style={'display': 'flex', 'alignItems': 'center'}),
                                        'value': utils.poles[0]
                            ...
                            **pole_container_style,
                            'borderColor': utils.dicolor_poles[utils.poles[0]]
                        }),
                        ...
                        html.Div([
                                    ...
                                    options=[{
                                        'label': html.Span([
                                            ...
                                            html.Span('UTILISER', style={
                                                'fontWeight': '700',
                                                'fontSize': '16px',
                                                'color': utils.dicolor_poles[utils.poles[1]],
                                                'letterSpacing': '0.5px'
                                            })
                                        ], style={'display': 'flex', 'alignItems': 'center'}),
                                        'value': utils.poles[1]
                            ...
                            **pole_container_style,
                            'borderColor': utils.dicolor_poles[utils.poles[1]]
                        }),
                        ...
                        html.Div([
                                    ...
                                    options=[{
                                        'label': html.Span([
                                            html.Span('DÉPLOYER', style={
                                                'fontWeight': '700',
                                                'fontSize': '16px',
                                                'color': utils.dicolor_poles[utils.poles[2]],
                                                'letterSpacing': '0.5px'
                                            })
                                        ], style={'display': 'flex', 'alignItems': 'center'}),
                                        'value': utils.poles[2]
                            ...
                            **pole_container_style,
                            'borderColor': utils.dicolor_poles[utils.poles[2]]
                        })
                    ], style=filter_card_style)
                ], style={'flex': '2'})
            ], style={
