...
from app.legende import legende
    ...
    children=[
        html.Div([
            ...
            html.Div([
                html.Div([
                    ...
                    html.Div([
                        dcc.Dropdown(
                            searchable=False,
                            id='node-influence',
                            options=[{'label': n, 'value': n} for n in sorted(utils.df['Influence'].unique(), key=lambda x: int(x) if x !='nan' else 0)],
                        ...
                        dcc.Dropdown(
                            searchable=False,
                            id='node-interaction',
                            options=[{'label': n, 'value': n} for n in sorted(utils.df['Interaction'].unique(), key=lambda x: int(x) if x !='nan' else 0)],
                ...
                html.Div(
                    [html.Img(src='app/assets/logo_xlsx.png', id = 'logo_excel', style={'width': '80px', 'marginBottom': '10px', 'margin' : 'auto', 'display' : 'block'}),
